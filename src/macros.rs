...
macro_rules! instr {
    ...
    (
        con a16[$offset_dst_idx:literal],a16[$len_dst_idx:literal],s16[$src1_idx:literal],s16[$src2_idx:literal],a16[$frag_idx:literal]
    ) => {{
    ...
    (find a16[$should_be_0:literal],s16[$str_idx:literal],s16[$fragment_idx:literal]) => {{
